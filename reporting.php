...
$query=mysqli_query($con,"insert into emghistory(fullName,mobileNumber,location,messgae) value('$fname','$mno','$location','$message')");
if($query){
...
<?php include_once('includes/header.php') ?>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-12"><img class="img-fluid rounded mb-4 mb-lg-0" src="assets/photo2.jpg" alt="..." /></div>
            ...
            <div class="row gx-4 gx-lg-5">
                <div class="col-md-12 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Online Emergency Response System Report</h2>
