...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID,AdminName,isActive from emgadmin where  AdminuserName='$uname' && Password='$Password' ");
...
<p align="center">
      <img 
                                    src="uploadeddata/<?php echo $logo;?>"  width="150"> </p>
